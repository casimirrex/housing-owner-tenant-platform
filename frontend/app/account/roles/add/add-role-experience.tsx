...
/**
 * Inner experience for /account/roles/add — separated from page.tsx so the
 * useSearchParams() call lives below a Suspense boundary (Next.js 14 build
 * requirement for static pages that read query params).
 */
...
export function AddRoleExperience() {
